...
⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪⚘۪۬*Creador de Fenix:* 𝑬𝒏𝒛𝒊𝒕𝒐-𝑶𝑭𝑪*
⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪⚘۪۬*Numero de mi creador: wa.me/+5491168758497
⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪⚘۬ *Bot ofc:* wa.me/++5491168758497
...
┃ *< *Bot ofc* />*
├┈・─・﹕₊˚ ✦・୨୧・
┣ 𖤍 ${packname}${conn.user.jid == global.conn.user.jid ? '' : `\n║˚₊·˚₊· ͟͟͞͞➳* 𝑾𝑨𝑺𝑯𝑰𝑻𝑨-𝑩𝑶𝑻-𝑴𝑪 𝑆𝑈𝐵 𝐵𝑂𝑇 ⇢ *@${global.conn.user.jid.split`@`[0]}`}
 𖤍
╰ - ̗̀↳ꕤ—— 𖤍 —— ꕤ╯
